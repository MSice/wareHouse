  ...
  <div class="box">
    ...
    <div class="insert">
      ...
      <el-form :inline="true" :model="formInline1" class="demo-form-inline">
        <el-form-item label="管理员ID">
          <el-input v-model="formInline1.aid" placeholder="仓库编号"></el-input>
        </el-form-item>
        <el-form-item label="仓库容量">
          <el-input v-model="formInline1.content" placeholder="仓库容量"></el-input>
        </el-form-item>
        <el-form-item label="剩余空间">
          <el-input v-model="formInline1.snumber" placeholder="剩余空间"></el-input>
        </el-form-item>
        <el-form-item label="仓库详情">
          <el-input v-model="formInline1.remarks" placeholder="仓库详情"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <div class="content">
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column fixed prop="w_id" label="仓库编号" width="200"></el-table-column>
        <el-table-column prop="w_aid" label="管理员ID" width="200"></el-table-column>
        <el-table-column prop="w_content" label="仓库容量" width="200"></el-table-column>
        <el-table-column prop="w_snumber" label="剩余空间" width="200"></el-table-column>
        <el-table-column prop="w_remarks" label="仓库详情" width="500"></el-table-column>
...
export default {
  ...
  methods: {
    //查询所有仓库信息
    getInfo() {
      this.$store.dispatch("warehouse/selectAll", data => {
